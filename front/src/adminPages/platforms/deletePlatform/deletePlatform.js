...
function DeletePlatform() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-md">
      <h1 className="text-2xl font-bold mb-6 text-gray-800">Excluir Plataforma</h1>
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
              <h3 className="text-lg font-medium text-gray-800">{platform.name}</h3>
              <p className="mt-2 text-sm text-gray-600">ID: {platform.id}</p>
            </div>
